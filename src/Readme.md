...
JDBC-Student-Records/
├── src/
│   └── DisplayStudents.java
├── README.md
└── ojdbc.jar (added as dependency)
...
INSERT INTO students (id, name, age) VALUES (1, 'Aarav', 20);
INSERT INTO students (id, name, age) VALUES (2, 'Isha', 21);
INSERT INTO students (id, name, age) VALUES (3, 'Rohan', 19);
